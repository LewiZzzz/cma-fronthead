    ...
    <ContentBase>
        ...
        <div class="modal fade" id="projectParmModal" tabindex="-1" aria-labelledby="projectParmModal" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="projectModalLabel">标准参数导航框</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <p v-for="(param) in this.selectedStandard.params" :key="param.id" class="mb-3"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <p class="flex-container"><span>人员</span><button type="button" class="btn btn-primary ms-2"
                                data-bs-toggle="modal" data-bs-target="#paramPersonnelModal">查看详细信息</button></p>
                        <p class="flex-container"><span>设备</span><button type="button" class="btn btn-primary ms-2"
                                data-bs-toggle="modal" data-bs-target="#paramInstrumentModal">查看详细信息</button></p>
                        <p class="flex-container"><span>样品</span><button type="button" class="btn btn-primary ms-2"
                                data-bs-toggle="modal" data-bs-target="#paramSampleModal">查看详细信息</button></p>
                        <p class="flex-container"><span>检验细则</span><button type="button" class="btn btn-primary ms-2"
                                data-bs-toggle="modal" data-bs-target="#paramSOPModal">查看详细信息</button></p>
                        <p class="flex-container"><span>设施</span><button type="button" class="btn btn-primary ms-2"
                                data-bs-toggle="modal" data-bs-target="#paramFacilityModal">查看详细信息</button></p>
                        <p class="flex-container"><span>比对验证</span><button type="button" class="btn btn-primary ms-2"
                                data-bs-toggle="modal" data-bs-target="#paramVerificationModal">查看详细信息</button></p>
                        <p class="flex-container"><span>模拟实验</span><button type="button" class="btn btn-primary ms-2"
                                data-bs-toggle="modal" data-bs-target="#paramSimulationExperimentModal">查看详细信息</button></p>
                        <p class="flex-container" v-for="(requirement) in this.selectedParam.extraRequirement"
                            :key="requirement.id">
                            <span>额外要求</span>
        ...
        <div class="modal fade" id="paramPersonnelModal" tabindex="-1" aria-labelledby="paramPersonnelModal"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <el-tag v-if="this.selectedParam.personnel.state == 0" type="success" class="me-2">已完成</el-tag>
                        <el-tag v-if="this.selectedParam.personnel.state == 1" type="danger" class="me-2">未完成</el-tag>
                        <el-tag
                            v-if="this.selectedParam.personnel.reviewState == 0 && this.selectedParam.personnel.state == 0"
                            type="success" class="me-3">已审核</el-tag>
                        <el-tag
                            v-if="this.selectedParam.personnel.reviewState == 1 && this.selectedParam.personnel.state == 0"
                            type="warning" class="me-3">待审核</el-tag>
                        <br>
                        ...
                        <el-button type="primary" style="width: 100%" class="mb-3 mt-3"
                            v-if="this.selectedParam.personnel.reviewState == 1 && this.selectedParam.personnel.state == 0">审核</el-button>
                        <br>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-primary" data-bs-toggle="modal"
        ...
        <div class="modal fade" id="paramInstrumentModal" tabindex="-1" aria-labelledby="paramInstrumentModal"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <el-tag v-if="this.selectedParam.instrument.state == 0" type="success" class="me-2">已完成</el-tag>
                        <el-tag v-if="this.selectedParam.instrument.state == 1" type="danger" class="me-2">未完成</el-tag>
                        <el-tag
                            v-if="this.selectedParam.instrument.reviewState == 0 && this.selectedParam.personnel.state == 0"
                            type="success" class="me-3">已审核</el-tag>
                        <el-tag
                            v-if="this.selectedParam.instrument.reviewState == 1 && this.selectedParam.personnel.state == 0"
                            type="warning" class="me-3">待审核</el-tag>
                        <br>
                        <div class="mt-2 mb-3">
                        ...
                        <el-button type="primary" style="width: 100%" class="mb-3 mt-3"
                            v-if="this.selectedParam.instrument.reviewState == 1 && this.selectedParam.instrument.state == 0">审核</el-button>
